...
|---|---|---|---|
| Classification Accuracy | **70.3%** | ≥ 65% (rule-based) | ✅ PASS |
...
|---|---|---|---|---|---|---|
| CLASS | 29 | 27 | 34 | 79.4% | 93.1% | 0.857 |
| ER | 7 | 7 | 7 | 100.0% | 100.0% | 1.000 |
| SEQUENCE | 19 | 18 | 32 | 56.3% | 94.7% | 0.706 |
| USE_CASE | 7 | 7 | 14 | 50.0% | 100.0% | 0.667 |
| COMPONENT | 6 | 6 | 7 | 85.7% | 100.0% | 0.923 |
| DEPLOYMENT | 6 | 6 | 7 | 85.7% | 100.0% | 0.923 |
...
| 2 | CLASS | USE_CASE | 50% | A Movie can have many Actors. An Actor can appear in many Movies. Each appearance has a character... |
| 3 | OBJECT | CLASS | 25% | Instance s1 of Student has studentId=S001 and name=Alice. Instance c1 of Course has courseCode=CS... |
| 4 | OBJECT | CLASS | 25% | Object car1 is of type Car with make=Toyota and model=Camry. Object engine1 is of type Engine and... |
| 5 | OBJECT | USE_CASE | 35% | Snapshot: admin1 is an instance of AdminUser with username=alice. admin1 manages department1 whic... |
| 6 | OBJECT | CLASS | 25% | Runtime state: order1 is an Order with status=pending. lineItem1 and lineItem2 are OrderItem inst... |
| 7 | OBJECT | CLASS | 25% | bank1 is an instance of Bank named NationalBank. account1 is a SavingsAccount with balance=1500 o... |
| 8 | OBJECT | CLASS | 35% | Object diagram snapshot: library1 is a Library. book1 is a Book with title=Clean Code. member1 is... |
| 9 | OBJECT | CLASS | 25% | Show the runtime objects: product1 is a Product with price=29.99. cart1 is a Cart owned by user1.... |
| 10 | CLASS | USE_CASE | 25% | A social media platform: User creates many Posts. Post has many Comments. Comment is created by a... |
| 11 | COLLABORATION | DEPLOYMENT | 25% | User --> WebServer : 1 searchMessage()
WebServer --> WebServer : 1.1 createSQLQuery()
WebServer -... |
| 12 | COLLABORATION | SEQUENCE | 50% | Collaboration diagram: User sends searchMessage() to WebServer. WebServer creates an SQL query in... |
| 13 | COLLABORATION | CLASS | 25% | Objects: User, WebServer, SQLServer. User --> WebServer : 1 search(). WebServer --> WebServer : 1... |
| 14 | COLLABORATION | SEQUENCE | 35% | Communication diagram for web search: User interacts with WebServer. WebServer interacts with SQL... |
| 15 | COLLABORATION | SEQUENCE | 64% | Draw a collaboration diagram showing User, WebServer, and SQLServer. The user sends a search requ... |
| 16 | COLLABORATION | USE_CASE | 35% | User --> WebServer : 1 initiatePayment()
WebServer --> WebServer : 1.1 validateInput()
WebServer ... |
| 17 | COLLABORATION | SEQUENCE | 64% | Collaboration diagram for electronic payment. Participants: User, WebServer, SQLServer, Transacti... |
| 18 | COLLABORATION | SEQUENCE | 35% | Objects: User, WebServer, TransactionServer, SQLServer. Messages: 1 pay() User to WebServer, 1.1 ... |
| 19 | COLLABORATION | USE_CASE | 35% | Communication diagram: User, PaymentGateway, TransactionServer, Bank. 1 pay() from User to Paymen... |
| 20 | COLLABORATION | USE_CASE | 55% | Draw a collaboration diagram for an electronic payment scenario with User, WebServer, SQLServer, ... |
| 21 | COLLABORATION | SEQUENCE | 25% | User --> ATM : 1 insertCard()
ATM --> Bank : 1.1 verifyCard()
Bank --> ATM : 1.2 cardVerified()
U... |
| 22 | COLLABORATION | SEQUENCE | 50% | Collaboration diagram for ATM withdrawal. Objects: User, ATM, Bank, CashDispenser. User inserts c... |
| 23 | COLLABORATION | SEQUENCE | 35% | Communication diagram: User, ATM, Bank. 1 insertCard() from User to ATM. 1.1 authenticateCard() f... |
| 24 | COLLABORATION | SEQUENCE | 45% | Objects: ATM, Bank, CashDispenser. ATM interacts with Bank and CashDispenser. Numbered messages: ... |
| 25 | COLLABORATION | SEQUENCE | 95% | Draw a collaboration diagram for an ATM cash withdrawal involving User, ATM, Bank, and CashDispen... |
| 26 | COLLABORATION | SEQUENCE | 25% | User --> Register : 1 insertCoin()
Register --> Register : 1.1 validateCoin()
User --> Register :... |
| 27 | COLLABORATION | SEQUENCE | 50% | Collaboration diagram for a soda vending machine. Objects: User, Register, Dispenser. User insert... |
| 28 | COLLABORATION | SEQUENCE | 25% | Communication diagram: User, Register, Dispenser. 1 insertCoin() from User to Register. 1.1 check... |
| 29 | COLLABORATION | SEQUENCE | 95% | Objects: User, Register, Dispenser. Messages with sequence numbers: 1 coinInserted() User to Regi... |
| 30 | COLLABORATION | USE_CASE | 45% | Draw a collaboration diagram for a soda machine scenario with User, Register, and Dispenser. Incl... |
